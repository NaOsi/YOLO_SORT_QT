...
private:
    ...
    void drawPred(int classId, double conf, int left, int top, int right, int bottom, Mat &frame);
    ...
    const string darknet_cfg = "/home/user/code/www/YOLO_SORT_QT/model/yolov3.cfg";         // 网络文件
    const string darknet_weights = "/home/user/code/www/YOLO_SORT_QT/model/yolov3.weights"; // 模型文件
